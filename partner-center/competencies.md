...
[加入 Microsoft 合作夥伴網路](manage-your-partner-network-membership.md)之後，您就可以挑戰績效或技能目標來贏得 Microsoft 專長認證。 
...
若要購買銀級權益套件，您只需要在一個路徑中展示銀級熟練程度。 升級到銀級之後，我們就會在您的行銷設定檔中顯示您已經達成的所有銀級專長認證。 

若要購買金級權益套件，您只需要在一個路徑中展示金級熟練程度。 升級到金級之後，我們會在您的行銷設定檔中顯示您已經達成的銀級和金級專長認證。 
...
若要在相同等級續約或升級您的會員資格，您的組織必須再次符合專長認證要求。
