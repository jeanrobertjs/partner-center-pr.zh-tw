...
>[!Note]
> Azure Active Directory (AAD) 租用戶角色包含全域管理員、 使用者管理員和 CSP 的角色。 非 AAD 角色是要管理租用戶，這些角色，其中包括 MPN 管理、 商務設定檔管理員、 轉介系統管理員、 獎勵的系統管理員，以及獎勵的使用者。 
...
|**角色** | **您可以執行**|
|----------------------------|:----------------------------|
|MPN 合作夥伴系統管理員|• 檢視中，建立和管理協力廠商服務要求||
||• 檢視法律、 公司、 商業及 MPN 設定檔
||• 檢視使用者詳細資料和他們的技能的資料
||• 檢視專長認證
||• 檢視及管理優點
