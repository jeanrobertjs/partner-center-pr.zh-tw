...
> [!IMPORTANT]
> 當您需要為您在 Azure 中的客戶建立服務要求時，請注意下列項目：
>
...
2. 完成服務要求表單，然候選取 **\[提交\]**。
   ...
   > [!TIP]
   > 請務必包含您連絡人資訊，而非客戶連絡資訊。

3. 接下來，移至 Office 365 系統管理中心並選取 **\[查看所有支援票證\]**，以檢閱您的客戶的服務要求。

### <a name="support-for-azure-marketplace-products"></a>Azure Marketplace 產品的支援

Microsoft 不提供 Azure Marketplace 產品的產品支援。 您將需要連絡發行者以取得支援的產品獨立軟體廠商 (ISV)。

若要尋找 ISV 的連絡資訊：

1.  在 Marketplace 頁面上，選取您需要協助的產品。
2.  產品的頁面上，您會發現支援連絡資訊。 這可能是一或多個下列內容：
    - 支援進入點上 ISV 網站的連結
    - 支援電子郵件 
    - 支援連絡電話號碼
