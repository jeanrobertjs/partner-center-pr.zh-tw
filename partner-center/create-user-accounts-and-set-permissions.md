...
>**注意**<br> 您現在可以在合作夥伴中心指派三個角色給使用者以協助您管理業務：MPN 系統管理員、商務設定檔系統管理員，以及推薦系統管理員。如需每個角色的詳細資料，請參閱下方的「指派使用者權限」。
...
4.  選取您要指派給使用者的代理人類型及/或系統管理員類型。 合作夥伴中心存取權是以角色為基礎，讓您可以指派權限，自訂使用者檢視，只顯示使用者完成特定工作所需的功能。 如需各角色可以採取什麼動作的詳細資訊，請參閱下方的「指派使用者權限」。
...
對於每個使用者，您必須至少指派一個權限等級。 這些等級的其中一個可以是預設等級，也就是**「以下列身分管理您的組織帳戶」**。 如果您未指派角色給使用者，他們就無法在合作夥伴中心中工作。
